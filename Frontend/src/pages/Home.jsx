...
const Home = () => {
  ...
  const [unreadNotifications, setUnreadNotifications] = useState(5); // Example: 5 unread notifications
      ...
      <div className="grid grid-cols-2 gap-4 w-full max-w-xs">
        ...
        <div className="relative inline-block">
          ...
          {unreadNotifications > 0 && (
            <span className="absolute top-0 right-0 mt-1 mr-1 inline-flex items-center justify-center h-5 w-5 text-xs font-bold leading-none text-white  rounded-full">
